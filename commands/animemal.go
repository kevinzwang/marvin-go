...
// AnimeMal gives info about the queried anime
//
// Deprecated: This used to be the `Anime` struct, and used MAL, but I switched to Anilist
type AnimeMal struct{}

func (cmd *AnimeMal) execute(ctx *Context, args []string) {
...
func (cmd *AnimeMal) description() string { return "gives info about the queried anime" }

func (cmd *AnimeMal) category() string { return "weeb" }

func (cmd *AnimeMal) numArgs() (int, int) { return 1, -1 }

func (cmd *AnimeMal) names() []string { return []string{"anime"} }

func (cmd *AnimeMal) onlyOwner() bool { return false }

func (cmd *AnimeMal) usage() []string { return []string{"<Anime Title>"} }
